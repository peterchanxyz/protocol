...
// UnimplementedWalletSolidityServer should be embedded to have forward compatible implementations.
...
// UnimplementedWalletExtensionServer should be embedded to have forward compatible implementations.
